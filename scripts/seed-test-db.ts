...
await prisma.$transaction(async (tx) => {
	...
	const properties = await Promise.all([
		...
		tx.property.create({
			data: {
				source_url: "https://test.redeal.local/yasamal-first-floor",
				price: 800000,
				area_sqm: 80,
				price_per_sqm: 10000,
				district: "Yasamal",
				...
				total_floors: 12,
				category: "Yeni tikili",
				description: "First-floor outlier listing",
				image_urls: [],
				posted_date: previous,
			},
		}),
		tx.property.create({
			data: {
				source_url: "https://test.redeal.local/yasamal-last-floor",
				price: 660000,
				area_sqm: 60,
				price_per_sqm: 11000,
				district: "Yasamal",
				...
				total_floors: 12,
				category: "Yeni tikili",
				description: "Last-floor outlier listing",
				image_urls: [],
				posted_date: previous,
			},
		}),
		tx.property.create({
			data: {
				source_url: "https://test.redeal.local/yasamal-null-fields",
				price: 100000,
				area_sqm: 100,
				price_per_sqm: 1000,
				district: "Yasamal",
				...
				has_mortgage: null,
				has_repair: null,
				description: "Sea View CORNER null optional fields",
				image_urls: [],
				posted_date: now,
			},
		}),
