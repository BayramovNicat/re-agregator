...
const translations = {
	en: {
		...
		validateDone: "Removed {deleted} ended listings. Fresh total: {total}.",
		jsonReviewBtn: "JSON Review",
		jsonReviewTitle: "Review JSON items",
		jsonReviewDesc:
			"Paste a JSON array with item_id values. Matching listings are loaded from the database and shown with your notes.",
		jsonReviewPlaceholder: "Paste JSON array here...",
		jsonReviewFetch: "Fetch items",
		jsonReviewLoading: "Loading items...",
		jsonReviewArrayError: "JSON must be an array.",
		jsonReviewParseError: "Invalid JSON.",
		jsonReviewStatus: "Matched {matched} of {total} items.",
		jsonReviewMatched: "Matched",
		jsonReviewMissing: "Missing in DB",
		jsonReviewPaved: "Paved",
		...
		statsBtn: "Stats",
		scrapeOps: "Scrape Ops",
		runNow: "Run now",
		scrapeRuns: "Scrape runs",
		scrapeRunSubtitle: "Latest scrape activity",
		scrapeRunEmpty: "No scrape runs yet",
		scrapeRunLoading: "Loading scrape runs…",
		scrapeRunRunning: "Running…",
		scrapeRunError: "Failed to load scrape runs",
		scrapeRunStatus: "Status",
		scrapeRunTrigger: "Trigger",
		scrapeRunDuration: "Duration",
		scrapeRunFetched: "Fetched",
		scrapeRunPersisted: "Persisted",
		scrapeRunSkipped: "Skipped",
		scrapeRunErrors: "Errors",
		scrapeRunPlatform: "Platform",
	...
	az: {
		...
		validateDone: "Bitmiş {deleted} elan silindi. Yeni cəmi: {total}.",
		jsonReviewBtn: "JSON baxış",
		jsonReviewTitle: "JSON elanlarına baxış",
		jsonReviewDesc:
			"item_id dəyərləri olan JSON massivini yerləşdirin. Uyğun elanlar bazadan yüklənəcək və qeydlərlə göstəriləcək.",
		jsonReviewPlaceholder: "JSON massivini bura yerləşdirin...",
		jsonReviewFetch: "Elanları gətir",
		jsonReviewLoading: "Elanlar yüklənir...",
		jsonReviewArrayError: "JSON massiv olmalıdır.",
		jsonReviewParseError: "Yanlış JSON.",
		jsonReviewStatus: "{total} elandan {matched} tapıldı.",
		jsonReviewMatched: "Tapıldı",
		jsonReviewMissing: "Bazarda yoxdur",
		jsonReviewPaved: "Asfalt",
		...
		scrapeOps: "Scrape Ops",
		runNow: "İndi işə sal",
		scrapeRuns: "Scrape işləri",
		scrapeRunSubtitle: "Son scrape fəaliyyəti",
		scrapeRunEmpty: "Hələ scrape yoxdur",
		scrapeRunLoading: "Scrape işləri yüklənir…",
		scrapeRunRunning: "İşləyir…",
		scrapeRunError: "Scrape işləri yüklənmədi",
		scrapeRunStatus: "Status",
		scrapeRunTrigger: "Səbəb",
		scrapeRunDuration: "Müddət",
		scrapeRunFetched: "Toplanan",
		scrapeRunPersisted: "Yazılan",
		scrapeRunSkipped: "Atlanan",
		scrapeRunErrors: "Xətalar",
		scrapeRunPlatform: "Platforma",
	...
	ru: {
		...
		validating: "Проверка…",
		validateDone: "Удалено завершённых: {deleted}. Новый итог: {total}.",
		jsonReviewBtn: "JSON обзор",
		jsonReviewTitle: "Обзор JSON объявлений",
		jsonReviewDesc:
			"Вставьте JSON-массив с item_id. Совпадающие объявления будут загружены из базы и показаны с вашими заметками.",
		jsonReviewPlaceholder: "Вставьте JSON-массив сюда...",
		jsonReviewFetch: "Загрузить",
		jsonReviewLoading: "Загрузка объявлений...",
		jsonReviewArrayError: "JSON должен быть массивом.",
		jsonReviewParseError: "Некорректный JSON.",
		jsonReviewStatus: "Найдено {matched} из {total}.",
		jsonReviewMatched: "Найдено",
		jsonReviewMissing: "Нет в базе",
		jsonReviewPaved: "Асфальт",
		...
		scrapeOps: "Scrape Ops",
		runNow: "Запустить",
		scrapeRuns: "Запуски скрейпера",
		scrapeRunSubtitle: "Последняя активность скрейпера",
		scrapeRunEmpty: "Запусков пока нет",
		scrapeRunLoading: "Загрузка запусков…",
		scrapeRunRunning: "Выполняется…",
		scrapeRunError: "Не удалось загрузить запуски",
		scrapeRunStatus: "Статус",
		scrapeRunTrigger: "Запуск",
		scrapeRunDuration: "Длительность",
		scrapeRunFetched: "Получено",
		scrapeRunPersisted: "Сохранено",
		scrapeRunSkipped: "Пропущено",
		scrapeRunErrors: "Ошибки",
		scrapeRunPlatform: "Платформа",
